...
let student1 = new Student("준현",120000,"javascript");
console.log(student1.name);
console.log(student1.age);
console.log(student1.Study);


// 5. Tutee 클래스를 만들어주세요 Tutee는 Student을 상속받습니다.  
...
class Tutee extends Student{
    ...
    info(){
        console.log(`제 이름은 ${this.name}이고 나이는 ${this.age}이며, ${this.Study}를 학습하고 있슴다.`)
    }
}
